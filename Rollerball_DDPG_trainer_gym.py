...
To run
------
python Rollerball_DDPG_trainer_gym.py --train/test
"""
...
TEST_EPISODES = 100  # total number of episodes for training
...
if __name__ == '__main__':
    ...
    # env = UE(file_name='RollerBall', seed=1, side_channels=[])
    unity_env = UE(file_name='D:\WG\Github\DRL-Rollerball-Unity\RollerBall\RollerBall', seed=1, side_channels=[channel],
                   no_graphics=True)
    ...
    agent = DDPG(action_dim, state_dim, action_bound)
